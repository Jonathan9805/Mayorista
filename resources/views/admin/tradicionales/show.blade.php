...
@section('content')
    <div class="row">
        <h1>Nombre: {{ $tradicional->giro_comercial }}</h1>
    </div>
    <hr>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form group">
                                    ...
                                    <p>{{ $tradicional->giro_comercial }}</p>
                                </div>
                            </div>
                            <br>
                            <div class="col-md-4">
