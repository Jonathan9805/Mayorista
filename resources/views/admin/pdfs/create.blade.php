...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                <form action="{{ url('/admin/pdfs/create') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form group">
                                <label for="">Certificados de Honorabilidad 1</label><b>*</b>
                                <br>
                                <input type="file" name="certificado_honorabilidad1" value="{{ old('certificado_honorabilidad1') }}" class="form-control" required>
                                @error('certificado_honorabilidad1')
                                <small style="color: red">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form group">
                                <label for="">Certificados de Honorabilidad 2</label><b>*</b>
                                <br>
                                <input type="file" name="certificado_honorabilidad2" value="{{ old('certificado_honorabilidad2') }}" class="form-control" required>
                                @error('certificado_honorabilidad2')
                                <small style="color: red">{{ $message }}</small>
                                @enderror
                            </div>
                        </div>
